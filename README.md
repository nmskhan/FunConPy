...
- If you've provided at T1 anatomical image then this sequence is followed:
    - func-to-t1 (FSL rigid flirt 6dof / ANTs affine with BOLDAff)
    - t1-to-standard (FSL nonlinear with fnirt / ANTs nonlinear with SyN)

**Step 5**
Regress out CSF and WM signal using masks generated by FAST.

**Step 6**
Band-pass filtering to remove high or low frequency noise using AFNI's 3dBandpass:
